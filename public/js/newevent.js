$(document).ready(function() {
    ...
    $("#newevent").click(function(event) {
                ...
                // If we have an all field filled out, run the newEvent function
                    newEvent(eventData.eventInput, eventData.movieInput, eventData.dateInput, eventData.locationInput, eventData.descriptionInput);
                    eventInput.val("");
                    movieInput.val("");
                    dateInput.val("");
                    locationInput.val("");
                ...
                function newEvent(eventInput, movieInput, dateInput, locationInput, descriptionInput) {
                    $.post("/api/newevent", {
